...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    support: [
      ...
      { name: 'Driver Resources', path: '/resources' },
  ...
  const socialLinks = [
    ...
    { name: 'Instagram', icon: 'instagram', url: 'https://instagram.com/driverlynk' }
  ];
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                <Link to="/" className="flex items-center space-x-2 group">
                  <div className="w-12 h-12 bg-gradient-primary rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-glow transition-shadow duration-300">
